            ...
            <div class="collapse navbar-collapse" id="navbarColor03">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active ">
                        <a class="nav-link" style="color: white;">Boleta de Ingreso<span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
            ...
            <form action="" style="">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" class="form-control" name="txtNumColaboradoras" id="txtNumColaboradoras">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="txtNumColaboradores">Número de Colaboradores</label>
                        <input type="number" class="form-control" name="txtNumColaboradores" id="txtNumColaboradores">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="txtNumColaboradoresTemp">Número de Colaboradores(as) temporales</label>
                        <input type="text" class="form-control" name="txtNumColaboradoresTemp"
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" class="form-control" name="txtRango1"
                               id="txtRango1">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="txtRango2">26 a 34 años</label>
                        <input type="number" class="form-control" name="txtRango2"
                               id="txtRango2">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="txtRango3">35 a 44 años</label>
                        <input type="number" class="form-control" name="txtRango3"
                               id="txtRango3">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="txtRango4">45 años en adelante</label>
                        <input type="number" class="form-control" name="txtRango4"
                               id="txtRango4">
                    </div>
                </div>
                <h6 style="margin-top:2%; margin-bottom:2%; color: #162A47;" class="text-info">Del total de colaboradores en su empresa, indique el número exacto
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" class="form-control" name="txtMaya"
                               id="txtMaya">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="txtGarífuna">Garífuna</label>
                        <input type="number" class="form-control" name="txtGarífuna"
                               id="txtGarífuna">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="txtXinca">Xinca</label>
                        <input type="number" class="form-control" name="txtXinca"
                               id="txtXinca">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="txtMestizo">Mestizo</label>
                        <input type="number" class="form-control" name="txtMestizo"
                               id="txtMestizo">
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <button type="button" class="btn " style="background-color: #162A47; color: white; align-self: center;">Siguiente</button>
                </div>
